...
\il{Faroese}\il{Norwegian}\il{Nynorsk}\il{Norse!East}\il{Danish}\il{Bokmål}\il{Swedish}\il{Germanic!West}\il{Germanic!North Sea}%
...
\questions{
\begin{enumerate}
\item Name at least ten Germanic languages.
\end{enumerate}
