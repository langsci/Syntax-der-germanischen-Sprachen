...
am Ende des Satzes angefügt. Im entsprechenden dänischen\il{Dänisch} Beispiel, das aus \citet[\page 146]{Oersnes2009b} adaptiert wurde, ist es genau umgekehrt:
...
Es ist interessant festzustellen, dass die deutsche\il{Deutsch} und die dänische\il{Dänisch} Frage mit nur einem einzigen Verb genau
...
für Fernabhängigkeiten (sogenannte „Konstituentenbewegung“).\footnote{
  ...
  betrifft. Siehe \citew[Kapitel~15]{MuellerGT-Eng5} und \citew[Abschnitt~3.2]{Wasow2021a} zur Diskussion.
}
...
haben \citegen[\page 224]{Laenzlinger2004a} Analyse eines deutschen\il{Deutsch} Satzes bereits in
...
ist, dass Haider annimmt, dass es in einfachen englischen\il{Englisch} SVO-Strukturen Kopf"=bewegung gibt. Der Kopf beginnt links von ZP,
...
komplizierten Kopf"=bewegungsansatz für englische\il{Englisch} verbale Projektionen anzunehmen.
...
als \citew{Sag2020a} veröffentlicht. Sag schlägt eine flache Analyse englischer\il{Englisch} VPs vor. Das bedeutet, dass das
...
germanischen\il{Germanisch} V2-Sprachen, da wir uns nicht darauf verlassen können, dass Wissen über diese Strukturen
...
\item Skizzieren Sie die Analyse für die folgenden Beispiele. Verwenden Sie die Valenzmerkmale \spr und \comps
  ...
  leere Liste ist, können Sie ihn in den deutschen\il{Deutsch} Beispielen weglassen. NPs und PPs können als NP bzw.\ PP
