...
(und anderer \ili{germanisch}er Sprachen, \eg \ili{Niederländisch}, \ili{Friesisch}, \ili{Afrikaans} und ihrer regionalen
...
\ex 
 Wer$_i$ wohl    meint   er, dass \_$_i$ ihm seine Arbeit hier bezahlen werde?\footnotemark
\footnotetext{
...
\label{ex-wen-glaubst-du-dass}
 Wen$_i$ glaubst du, daß ich \_$_i$ gesehen habe.\footnotemark
\footnotetext{
    \citew[\page84]{Scherpenisse86a}.
    }
\ex 
 "`Wer$_i$, glaubt\iw{glauben} er, daß er \_$_i$ ist?"' erregte sich ein Politiker vom Nil.\footnotemark
\footnotetext{
...
\ex\label{bsp-um-zwei-millionen}
 {}[Um zwei Millionen Mark]$_i$ soll er versucht haben, [eine Versicherung \_$_i$ zu betrügen].\footnotemark
\footnotetext{
         taz, 2001-05-04, p.\,20.
}
\ex
 {}[Gegen ihn]$_i$ falle es den Republikanern hingegen schwerer, [~[~Angriffe \_$_i$] zu lancieren].\footnotemark
\footnotetext{
  taz, 2008-02-08, p.\,9.
}
\zl
