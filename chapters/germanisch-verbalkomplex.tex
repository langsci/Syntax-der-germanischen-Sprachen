...
SOV"=Sprachen\is{Verbalkomplex|(} wie das \ili{Niederländisch} und das \ili{Deutsch} bilden Verbalkomplexe, das heißt
...
Es sei angemerkt, dass es in den \ili{deutsch}en Dialekten extreme Variation gibt, was die Serialisierung
...
} Verb wird im Standard\-\ili{deutsch}en rechts vom
...
\eal
\ex
Ich hätte stapelweise Akten kön\-nen haben.\hfill (\ili{deutsch}er Berliner Dialekt)
\ex
...
\ili{niederländisch}e Beispiele:
\eal
\ex
...
werden \ili{deutsch}e Subjekte in der \comps-Liste finiter Verben repräsentiert. Daher hat der Lexikoneintrag für
...
in SVO-Sprachen analysiert werden können. Abbildung~\vref{fig-vp-embedding-svo} zeigt die Analyse der \ili{englisch}en Version von Satz
...
Das Äquivalent von \emph{lesen können wird} kann hier nicht angegeben werden, da \ili{englisch}e Modalverben\is{Verb!Modal}
...
\zl
Geben Sie bitte die \subj- und die \comps-Werte an. Die \spr-Werte können Sie weglassen, da sie für alle \ili{deutsch}en Verben ohnehin die leere Liste sind.
