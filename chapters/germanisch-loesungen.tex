...
\zl
Sie dürfen die \spr-Werte weglassen, da sie für alle \ili{deutsch}en Verben ohnehin die leere Liste sind.
...
\begin{enumerate}
\item Klassifizieren Sie die \ili{germanisch}en Sprachen nach ihrer grundlegenden Konstituentenabfolge (SVO, SOV, VSO,
...
SVO"=Sprache dem Verb folgen würde, muss es eine SOV"=Sprache sein. Da alle \ili{germanisch}en SOV"=Sprachen auch V2"=Sprachen
...
SOV/SVO nicht eindeutig klassifiziert werden. Da PPn leicht extraponiert werden können, könnte es eine SOV"=\pagebreak{}Sprache mit Extraposition sein (\eg{}
...
\item Skizzieren Sie die Analyse für die folgenden Beispiele. Verwenden Sie die in diesem Kapitel verwendeten
  Abkürzungen; das heißt, gehen Sie nicht auf die Details bezüglich \spr und \compsvs ein, sondern verwenden Sie S, VP und V$'$.
\eal
\ex
...
\item Skizzieren Sie die Analyse für die folgenden Beispiele. Verwenden Sie die Valenzmerkmale \spr und \comps
  ...
  leere Liste ist, dürfen Sie ihn in den \ili{deutsch}en Beispielen weglassen. NPn und PPn können als NP bzw. PP abgekürzt werden.
\eal
