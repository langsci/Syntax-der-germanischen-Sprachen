...
der Kopf einer Phrase ist oder den Kopf der Phrase enthält (\eg das Verb in einem Satz oder das Nomen in einer
...
modifizierten Knoten angegeben (\eg \spr \eliste, \comps \sliste{ \ibox{1}, \ibox{2} } in
...
kombiniert werden kann \parencites[296--297]{Jacobs94a}[393]{Jacobs2003a-u}. So kann zum Beispiel das Verb \emph{read} mit oder ohne Objekt verwendet werden.
\eal
...
\end{forest}}
\hfill\mbox{}
\caption{\label{fig-svo}Analyse von Sätzen mit zweiwertigem und einwertigem \emph{reads}}
\end{figure}
...
Objekt an eine höhere Position im Baum bewegt wird, \eg an die TP adjungiert wie in
...
\ea
\longexampleandlanguage{Ich denke, dass wahrscheinlich mindestens zwei leider ihren Vortrag absagen werden.}{Deutsch}
\z
...
\ea
\longexampleandlanguage{dass sie wen aus Hamburg wahrscheinlich / leider nicht heiraten würde}{Deutsch}
\z
...
explizite Diskussion siehe \citealt{Sag2007a}) und auch viele minimalistische Theorien (\eg \citealt[\page
