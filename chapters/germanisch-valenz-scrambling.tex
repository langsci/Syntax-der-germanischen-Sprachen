...
Objekt. \citet[Kapitel~48]{Tesniere2015a-u} schlug vor, zur Erklärung der Valenz die Analogie zu Dramen zu verwenden: Wenn wir
...
(\spr) genannt.\isfeat{spr}\footnote{%
  ...
  auch in den hier entwickelten Grammatiken angenommen wird. \citet[Abschnitt~3.3]{Sag2012a} präsentiert eine Version der HPSG
...
\citew[Kapitel~4]{MuellerLehrbuch3} oder \citew{Abeille:Borsley2021a} angegeben,
...
beteiligt ist. Die Spezifikation des \compswes der Kopftochter im Spezifikator-Kopf-Schema stellt sicher,
...
für die Analyse von NPs in allen germanischen\il{Germanisch} Sprachen verwendet. Abbildung~\ref{fig-spr-head-the-squirrel} zeigt die Analyse der NP \emph{the squirrel}.
\begin{figure}
\begin{forest}
...
Um die Dinge einfach zu halten, erwähnte das Spezifikator-Kopf\is{schema!Specifier-Head}-Schema den \compsw der Mutter nicht. Das
Kopf-Komplement-Schema erwähnte weder den \sprw der Kopftochter noch den der Mutter. Aber die
...
Mutterknotens identifiziert. Dies ist das \ibox{1} in (\mex{1}b). Ebenso muss der \compsw der Mutter
...
kopffinale Projektionen. Nomina in allen germanischen\il{Germanisch} Sprachen sind kopfinitial, das heißt, sie nehmen ihre
...
Spezifikation linguistischer Beschränkungen ist \parencites[Abschnitt~3]{AB2021a}[Abschnitt~2]{Richter2021a}. Werte wie die Wortart sind Typen, und Typen können
...
Flexionsklasse kongruiert \parencites[Abschnitt~2.2.5]{ps2}[Abschnitt~13.2]{MuellerLehrbuch3}, können die Eigenschaften, die das Nomen haben muss, innerhalb des \modv{} spezifiziert werden. Zum
...
- und \compswe zwischen Mutter und Kopftochter. An welches Element sich ein Adjunkt auch anlagert, die Valenz"=%
...
auch von \citet[Abschnitt~6.1]{KoenigRichter2021a} behandelt wird.
...
Minimalismus (der sogenannten Mainstream Generative Grammar) angenommen, sondern auch in Frameworks wie der LFG (\citealp[Abschnitt~6.2]{Bresnan2001a}; \citealp[Abschnitt~3.2.1]{Dalrymple2001a-u}). Allerdings
...
Negationspartikeln keine Köpfe, sondern Adjunkte sind. Siehe \citew{KS2002a} und \citew[Abschnitt~6]{Sag2020a} zur Negation im \ili{Englisch}en und
