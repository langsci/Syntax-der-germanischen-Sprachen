...
Ein Wort der Vorsicht ist hier nötig: Insbesondere die folgenden drei Abschnitte sind potenziell
...
Die Definition basiert auf semantischen Eigenschaften: \isi{Subjekt}e sind diejenigen
Argumente, die agensartig sind, und \isi{Objekt}e sind Argumente, die eher patiensartig sind. Diese Definition
...
erlaubt. Objekt-NPen können jedoch nicht gescrambelt werden:
\ea[*]{
...
\z
Der Grund dafür ist, dass NPen im \ili{Niederländisch}en nicht kasusmarkiert sind. Es wäre für Hörer
und Leser sehr schwierig herauszufinden, wer wem was angetan hat. Das ist parallel zu Beispielen mit kasuslosen NPen im
...
wir die Abfolge der determinatorlosen NPen in (\mex{-1}) ändern, erhalten wir dagegen eine andere Lesart:
\ea
...
\zl
Es wird angenommen, dass Verb und Objekte in diesen Sprachen eine strukturelle Einheit bilden, eine Verbphrase (VP). Adverbiale können
...
Wie in Abschnitt~\ref{sec-icelandic-quirky-subj} gezeigt werden wird, hat das \ili{Isländisch}e
Subjekte, die nicht im Nominativ stehen \citep{ZMT85a}, was es zur
