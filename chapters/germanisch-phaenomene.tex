...
(\mex{1}c).  Das dänische\il{Dänisch} Beispiel in (\mex{2}c), adaptiert nach \citet[\page 146]{Oersnes2009b}, entspricht dem
deutschen\il{Deutsch} Beispiel in (\mex{1}c).
...
\textcites[\page 15]{Haider2010a}[Section~15.2]{Haider2020a} weisen auf zwei weitere Unterschiede zwischen den germanischen\il{Germanisch} VO- und OV-Sprachen hin:
...
%%\largerpage[2]
\citet[Section~2.5]{Schallert2007a} weist darauf hin, dass viele germanische\il{Germanisch} Sprachen früherer Stufen keine
...
modernen \ili{Englisch}en \citep{HP86a-ed} sind die einzigen bekannten Fälle das \ili{Estnisch}e (Finno-Ugrisch, \citealp[\page 343]{Holmberg2015a}), das \ili{Sorbisch}e \citep[entry~79]{Plank2003b-ed} (eine slawische\il{Slawisch} Sprache), die
...
4]{Koster99a-u}[Section~6]{Bouma2003a-u}. (\mex{1}) zeigt die niederländischen\il{Niederländisch} Beispiele, die
(\mex{0}) entsprechen:
...
an der Komplexbildung teilnehmen. (\mex{1}) gibt ein deutsches\il{Deutsch} Beispiel, das von Haider übernommen ist (\citeyear[\page
