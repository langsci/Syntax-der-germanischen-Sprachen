...
Dieses Kapitel gibt einen Überblick über allgemeine Fakten zu den \ili{germanisch}en Sprachen. Es geht zurück auf
Folien für Lehrveranstaltungen über \ili{germanisch}e Sprachen, die von Ekkehard König verwendet und an
...
\section{Sprachen und Sprecher}

Je nachdem, wen man fragt, werden derzeit weltweit zwischen 5000 und 7000 Sprachen gesprochen. Die
\ili{germanisch}en Sprachen bilden eine kleine Teilmenge davon, je nach Zählung 15--20 Sprachen, weil die Unterscheidung zwischen Sprache und Sprachvarietät nicht immer nach denselben Kriterien getroffen wird (\zb Varietäten des \ili{Niederländisch}en).
...
Insgesamt haben die \ili{germanisch}en Sprachen fast 500 Millionen Muttersprachler, was 1/12 der gesamten Weltbevölkerung
entspricht. \ili{Englisch} ist besonders weit verbreitet, was die Regionen betrifft, in denen die Sprache gesprochen wird.


\section{Historische Anmerkungen und Verwandtschaft zwischen den Sprachen}


Die \ili{germanisch}en Sprachen bilden einen eigenen Zweig des Baums, der die \ili{indoeuropäisch}e
...
Die ersten schriftlichen Zeugnisse sind Runen aus etwa 300 n.\,Chr. und die \ili{gotisch}e Bibelübersetzung im vierten Jahrhundert.
Die erste \ili{germanisch}e Lautverschiebung fand vor dem zweiten Jahrhundert v.\,Chr. statt. In diesem Jahrtausend entwickelten die
\ili{germanisch}en Sprachen andere Konsonanten als die übrigen \ili{indoeuropäisch}en Sprachen.

\citet[\page 8]{Harbert2006a-u} stellt die Abbildung~\vref{fig-history-relations-germanic} bereit, die die Entwicklung der
\ili{germanisch}en Sprachen darstellt.
\begin{figure}
%\begin{sideways}
...
Das West\ili{germanisch}e besteht aus
\begin{itemize}
\item \ili{Deutsch},
\item \ili{Jiddisch},
\item \ili{Luxemburgisch},
\item Pennsylvania-\ili{Niederländisch},
...
\end{itemize}
\largerpage
Die nord\ili{germanisch}en Sprachen sind:
\begin{itemize}
\item \ili{Dänisch},
\item \ili{Schwedisch},
\item \ili{Norwegisch},
...
\noindent
Tabelle~\vref{tab-words-germanic} zeigt, wie ähnlich die Wörter aus dem Grundwortschatz der \ili{germanisch}en
Sprachen sind:
\begin{table}
\centerfit{%
...
Das \ili{Urgermanisch}e entwickelte sich etwa im ersten Jahrhundert n.\,Chr. zu den drei Hauptzweigen Ost-, West- und Nord\ili{germanisch}. Die Gründe für diese Entwicklung waren inhärente Variationen in den jeweiligen
Dialekten, Migration (Sprachkontakt) und Standardisierung. Dieses Buch behandelt die Struktur der
\ili{germanisch}en Standardsprachen. Dieser Abschnitt ist in drei Unterabschnitte gegliedert, die den
drei germanischen Hauptzweigen entsprechen. Ich werde die historischen Entwicklungen skizzieren, die zu den
heute gesprochenen Sprachen führten. Viele der Details, die in Abbildung~\ref{fig-history-relations-germanic} dargestellt sind, werden dabei ignoriert.



\subsection{Ostgermanisch}

Es\il{Germanisch!Ost|(} wird oft behauptet, dass die Goten von den \ili{dänisch}en Inseln und aus Südschweden auf das europäische Festland
...
Nach dem Zerfall der \ili{gotisch}en Reiche starb das \ili{Gotisch}e aus. Auf der Halbinsel Krim gab es einige Überreste
bis etwa 1800. Der west\ili{gotisch}e Bischof Wulfila (oder vielmehr ein von ihm geleitetes Team, siehe
\citealt{Ratkus2018a-u}) übersetzte die Bibel ins \ili{Gotisch}e. Die
bekannteste Fassung davon ist das Fragment Codex Argenteus, das zur Universitätsbibliothek von
Uppsala gehört. Abbildung~\vref{fig-Wulfila-Bibel} zeigt ein Bild davon.\footnote{
...
Grönlands ist. Das \ili{Dänisch}e hat etwa 5,5 Millionen Sprecher. Etwa 50.000 Sprecher leben in \href{https://en.wikipedia.org/wiki/Schleswig-Holstein}{Schleswig-Holstein}, dem nördlichsten der Bundesländer Deutschlands.
Das \ili{Dänisch}e ist die \ili{skandinavisch}e Sprache, die sich am weitesten von den gemeinsamen \ili{skandinavisch}en Wurzeln entfernt hat.


\subsubsection{Schwedisch}

Das \ili{Schwedisch}e (svenska) ist die Amtssprache in Schweden mit etwa 8,5 Millionen Muttersprachlern. Es ist
die Erstsprache von etwa 300.000 \ili{schwedisch}sprachigen Finnen in Finnland. Bis in die Zeit der
...
Das \ili{Isländisch}e (íslenska) ist seit der Besiedlung Islands vor über 1000 Jahren dessen west\ili{skandinavisch}e Sprache.
% Wikipedia 23.10.2014
Es gibt etwa 325.000 Muttersprachler. 97\,\% der \ili{isländisch}en Bevölkerung (325.000) haben das \ili{Isländisch}e als
Muttersprache, und es gibt große Gruppen von Muttersprachlern in Dänemark, den USA und Kanada
(insgesamt etwa 15.000).
Es gibt weniger Variation als in anderen \ili{germanisch}en Sprachen (keine Dialekte).
...
diejenige unter den \ili{germanisch}en Sprachen ist, die den \ili{germanisch}en Wortschatz und die Flexion am besten bewahrt hat.
...
% AZ: when?
ab etwa 1100 drifteten die Sprachen auseinander. Dieser Prozess setzte sich auch aufgrund des \ili{dänisch}en
Einflusses fort, und heutzutage ähnelt das \ili{Norwegisch}e mehr dem \ili{Dänisch}en als dem \ili{Isländisch}en. Es gibt viele schriftliche Zeugnisse auf \ili{Isländisch}.
...
Es gibt etwa 4,3 Millionen Sprecher.
...
Es wurde auch ein Standard entwickelt, der weniger vom \ili{Dänisch}en beeinflusst ist. Dies tat Ivar Aasen (1813--1896),
der das \ili{Nynorsk} entwickelte. Das \ili{Nynorsk} erhielt 1885 einen offiziellen Status. Das \ili{Bokmål} `Buchsprache' ist die Erstsprache der meisten
Norweger.

\subsubsection{Färöisch}

Das \ili{Färöisch}e (føroyskt) ist -- neben dem \ili{Dänisch}en -- eine Amtssprache der Färöer-Inseln. Es
gibt etwa 47.000 Sprecher. Die Färöer-Inseln gehören seit 1816 zu Dänemark. Seit 1948 sind sie
ein selbstverwaltetes Land innerhalb des \href{https://en.wikipedia.org/wiki/Danish_Realm}{\ili{dänisch}en Reichs}.
Das \ili{Färöisch}e hat einen starken \ili{dänisch}en Einfluss. Die erste handschriftliche Überlieferung stammt erst aus dem Jahr 1773, und
...
nehmen an, dass die west\ili{germanisch}en Sprachen keine gemeinsame Wurzel haben, sondern sich aus den
...
\begin{itemize}
\item Deutschland (etwa 80 Millionen Sprecher),
\item Österreich (etwa 7,5 Millionen Sprecher),
\item Liechtenstein (etwa 15.000 Sprecher),
\item der Schweiz (4,2 Millionen von 6,4 Millionen Einwohnern der Schweiz),
\item Norditalien/Südtirol (etwa 270.000 Sprecher),
\item Belgien (etwa 65.000 Sprecher) und
\item Luxemburg (etwa 360.000 Sprecher).
\end{itemize}
...
eine Minderheitensprache. Es gibt zwei große Dialektgruppen: das Niederdeutsche\il{Deutsch!Nieder-} (Plattdüütsch,
Nedderdüütsch; im Standard\ili{deutsch}en: Platt\-deutsch oder Nie\-der\-deutsch%
...
Das \ili{Jiddisch}e ist eine von vielen Sprachen, die in der jüdischen Diaspora gesprochen werden. Was die Sprecherzahl betrifft,
gibt es keine verlässlichen Zahlen: Einige Quellen gehen davon aus, dass
1,5 Millionen Menschen diese Sprache aktiv oder passiv sprechen, wobei nur 500.000 Sprecher die Sprache
aktiv im Alltag verwenden. Andere Quellen gehen von 4 Millionen
Sprechern aus. In jedem Fall war die Zahl der \ili{Jiddisch}sprecher vor 100 Jahren deutlich
höher: \citet[\page 6]{Birnbaum1915a-u} schätzte die Zahl der Sprecher auf bis zu 12 Millionen. Die meisten von
...
Schätzungen der Sprecherzahlen und weitere Literaturhinweise.
...
romanischen Sprachen beeinflusst, insbesondere von altfranzösischen\il{Französisch!Alt-} und \ili{italienisch}en Varietäten.


\subsubsection{Pennsylvania-Deutsch}

Das \ili{Pennsylvania-Deutsch}e (Pensilfaanish, Deitsch), das auch als Pennsylvania \ili{Dutch} bekannt ist, hat etwa 300.000
Muttersprachler, die hauptsächlich in den USA leben. Die wichtigsten Regionen sind Pennsylvania, Ohio und
Indiana. Das Pennsylvania-\ili{Deutsch}e ist das Ergebnis der Einwanderung im 17. und 18. Jahrhundert. Angehörige
verschiedener protestantischer Religionsgemeinschaften (Mennoniten, Pietisten und so weiter) verließen Europa aus religiösen Gründen,
doch später folgten Einwanderer, die aus wirtschaftlichen Gründen kamen. Die Sprache
basiert auf pfälzischen Dialekten und wird heutzutage hauptsächlich von Amischen und Mennoniten gesprochen.
...
Das \ili{Niederländisch}e (Nederlands) ist die Amtssprache der Niederlande und hat in diesem Land etwa 15 Millionen Sprecher. Das \ili{Niederländisch}e ist außerdem eine der Amtssprachen Belgiens mit etwa 6 Millionen Sprechern.
%AZleave out: ; almost 4 million Walloones).
Das \ili{Niederländisch}e ist die alleinige Amts- und Unterrichtssprache in Suriname
...
Es gibt etwa 6,4 Millionen Muttersprachler in Südafrika, was etwa 15\,\% der Bevölkerung entspricht,
und 150.000 in Namibia. Das \ili{Afrikaans} hat sich seit dem 17. Jahrhundert aus \ili{niederländisch}en Dialekten entwickelt und wird
...
etwa 10.000 Sprechern hauptsächlich auf den nord\ili{friesisch}en Inseln Amrum, Sylt und Helgoland gesprochen wird. Das Ostfriesische\il{Friesisch!Ost-}
...
Das Westfriesische\il{Friesisch!West-} wird in der nördlichen \ili{niederländisch}en Provinz Fryslân (Friesland) gesprochen und hat etwa 350.000
Muttersprachler.
...
Weltweit hatte das \ili{Englisch}e Ende des 20. Jahrhunderts etwa 570 Millionen Sprecher
(337 Millionen Muttersprachler, 235 Millionen Sprecher mit \ili{Englisch} als Zweitsprache\footnote{%
  Der Terminus \emph{Zweitsprache} bezeichnet Sprecher, die eine Sprache im
  Alltag verwenden, weil diese Sprache in der Umgebung, in der sie leben, gesprochen wird. Ein Beispiel wären Sprecher mit
  Türkisch als Erstsprache, die in Deutschland leben. Die \ili{deutsch}e Tradition unterscheidet
  \emph{Zweitsprache} von \emph{Fremdsprache}.%
}). Die Länder mit den meisten Muttersprachlern sind im Folgenden aufgeführt:
\begin{itemize}
