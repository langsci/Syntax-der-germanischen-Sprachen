...
sind, und so bescheiden ich bin, werde ich versuchen, zumindest für die germanischen\il{Germanisch} Sprachen
...
In den folgenden Unterabschnitten vergleiche ich mehrere Dimensionen, in denen die germanischen\il{Germanisch} Sprachen
variieren:
\begin{itemize}
...
dann auf die \sprl abgebildet werden \citep{MuellerDanishImpersonalPassive}. (\mex{1}) zeigt die Abbildung der
...
\end{tabular}}
\z
Man beachte, dass beide Mitglieder der \argstl auf \comps abgebildet werden. Der \compsw ist also eher derjenige, den man
...
germanischen\il{Germanisch} Sprachen erfasst. Das folgende AVM zeigt eine Beschränkung, die für alle \argst-Listen für Passivhilfsverben in germanischen\il{Germanisch} Sprachen gilt:\footnote{%
