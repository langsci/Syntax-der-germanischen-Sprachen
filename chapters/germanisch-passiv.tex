...
\ea[]{
Ich hoffe hier geholfen zu bekommen.\footnotemark
\footnotetext{    
...
Heute morgen bekam ich sogar schon gratuliert.\footnotemark
\footnotetext{%
...
"`Klärle"' hätte es wirklich mehr als verdient, auch mal zu einem "`unrunden"' Geburtstag gratuliert zu bekommen.\footnotemark
\footnotetext{
Mannheimer Morgen, 28.07.1999, Lokales; "`Klärle"' feiert heute Geburtstag.%
}
\ex 
Mit dem alten Titel von Elvis Presley "`I can't help falling in love"' bekam Kassier Markus Reiß zum Geburtstag gratuliert, [\ldots]\footnotemark
...
\eal
\ex\iw{versuchen|(}
daß  er        auch von mir zu überreden versucht wurde\footnotemark
\footnotetext{
...
%% }
\emph{der} \emph{zweite} \emph{Entwurf} wurde  zu bauen begonnen,\footnotemark
\footnotetext{
...
\eal
\ex 
Anordnungen, die zu stornieren vergessen \emph{wurden}\footnotemark
\footnotetext{
...
die so vorher nicht mal zu träumen gewagt \emph{wurden}?\footnotemark
\footnotetext{
...
\ex\iw{erlauben}
Keine Zeitung          wird   ihr       zu lesen erlaubt.\footnotemark
\footnotetext{
...
\ex\iw{auskosten}
Der Erfolg         wurde  uns       nicht auszukosten erlaubt.\footnotemark
\footnotetext{
