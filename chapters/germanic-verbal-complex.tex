...
single verb. This explains for instance why the arguments of the three verbs in (\mex{0}) can be scrambled:
...
The combination of \emph{lesen} and \emph{wird} behaves like a single verb in that it can be
...
\gll Aicke hat Conny versprochen, [sie das Buch zu lesen].\\
     Aicke has Conny promised     \spacebr{}she the book to read\\
...
\ili{German} subjects are represented in the \comps list of finite verbs. Hence the lexical item for
...
\subjl of this verb is plus whatever the \comps list of this verb is. This is exemplified for
...
readings of sentences that have quantifiers in their NPs (\citealp[\page 146]{Kiss2001a};
\citealp[Section~2.6]{Fanselow2001a}).\todostefan{Change discussion}
...
\zl
Please, provide the \subj and the \comps values. You may omit the \spr values, since they are the empty list for all \ili{German} verbs anyway.
